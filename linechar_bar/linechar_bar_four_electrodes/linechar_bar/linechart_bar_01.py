...
#OZ
fig_OZ= plt.figure(1,figsize=(4.3,1.37))
#fig_OZ.subplots_adjust(left=0.1, bottom=0.3, right=0.99, top=0.9, wspace=0.1, hspace=0.3)
#ax1 = fig_OZ.add_subplot(121)
ax1= fig_OZ.add_axes([0.085, 0.18,0.65,0.75])  # [left, bottom, width, height]
#hon
...
plt.legend(('Innocent','Guilty'),loc='upper right',ncol=1,fontsize=5,frameon = False)#,bbox_to_anchor=(10,0.5)
ax1.set_ylabel('Time_varying WE',fontproperties=font)
#ax1.set_xlabel('Time window',fontproperties=font)#Electrode Position
ax1.text(6.5,-0.25,'Time window',fontproperties=font)
...
ax2= fig_OZ.add_axes([0.81, 0.18,0.185,0.75])  # [left, bottom, width, height]
width =1
ind=np.arange(6)
ax2.set_xlim(0,7)
ax2.set_ylim(0,1.2)
...
ax2.text(1.3,-0.255,'WE method',fontproperties=font)
plt.yticks(fontsize=6)
...
ax1.set_ylabel('Time_varying WE',fontproperties=font)
#ax1.set_xlabel('Time window',fontproperties=font)#Electrode Position
ax1.text(6.5,-0.168,'Time window',fontproperties=font)
plt.yticks(fontsize=6)
elec2 = ('10', '11', '12', '13')#,'bad', 'good')
plt.xticks([1, (14*1/3)+1, (14*2/3)+1, (14*3/3)+1], elec2, fontproperties='Times New Roman', fontsize=6)
ax1.spines['right'].set_color('none')
...
#add the bar of innocent and guilty of bad and good
# the method of bad and good of hon
ax2= fig_PZ.add_axes([0.81, 0.18,0.185,0.75])  # [left, bottom, width, height]
width =1
ind=np.arange(6)
ax2.set_xlim(0,7)
ax2.set_ylim(0,0.8)
...
ax2.text(1.3,-0.17,'WE method',fontproperties=font)
ax2.yaxis.set_ticks_position('left')
plt.yticks(fontsize=6)
plt.xticks([])
plt.ylabel('WE',fontproperties=font)
...
###################################################################################
#CZ
fig_CZ= plt.figure(3,figsize=(4.3,1.37))
#fig_CZ.subplots_adjust(left=0.1, bottom=0.3, right=0.99, top=0.9, wspace=0.1, hspace=0.3)
#ax1 = fig_CZ.add_subplot(121)
ax1= fig_CZ.add_axes([0.085, 0.18,0.65,0.75])  # [left, bottom, width, height]
#hon
x=np.linspace(1,15,4)
...
#add the bar of innocent and guilty of bad and good
# the method of bad and good of hon
ax2= fig_CZ.add_axes([0.81, 0.18,0.185,0.75])  # [left, bottom, width, height]
width =1
ind=np.arange(6)
ax2.set_xlim(0,7)
ax2.set_ylim(0,1.2)
...
#add the bar of innocent and guilty of bad and good
# the method of bad and good of hon
ax2= fig_FZ.add_axes([0.81, 0.18,0.185,0.75])  # [left, bottom, width, height]
width =1
ind=np.arange(6)
ax2.set_xlim(0,7)
ax2.set_ylim(0,1.2)
